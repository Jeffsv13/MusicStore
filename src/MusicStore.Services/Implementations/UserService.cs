...
public class UserService : IUserService
{
    ...
    private async Task<LoginResponseDto> ConstruirToken(MusicStoreUserIdentity user)
    {
        ...
        {
            new Claim(ClaimTypes.Email, user.Email),//Nunca enviar data sensible en un claim, ya que es leido por el cliente
        ...
        var expiracion = DateTime.UtcNow.AddSeconds(options.Value.Jwt.LifetimeInSeconds);// se puede configurar cualquier espacio de tiempo
